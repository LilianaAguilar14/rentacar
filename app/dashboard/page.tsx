...
import { Car, CreditCard, Calendar, Clock, User } from "lucide-react"
...
// Datos de ejemplo para reservaciones activas
...
export default function DashboardPage() {
  ...
  useEffect(() => {
    // En un sistema real, aquí obtendrías los datos del usuario desde el backend
    setTimeout(() => {
    ...
    <div className="container mx-auto px-4 py-8">
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-8 gap-4">
        <div>
          ...
          <p className="text-gray-500">Aquí puedes gestionar tus reservaciones y suscripciones</p>
        </div>
        <Link href="/vehicles">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
        <Card>
          <CardContent className="p-6">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-sm font-medium text-gray-500">Reservaciones Activas</p>
                <h3 className="text-2xl font-bold mt-1">{userStats.activeReservations}</h3>
              </div>
        ...
        <Card>
          <CardContent className="p-6">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-sm font-medium text-gray-500">Reservaciones Completadas</p>
                <h3 className="text-2xl font-bold mt-1">{userStats.completedReservations}</h3>
              </div>
          ...
          <CardContent className="p-6">
            <div className="flex items-center justify-between">
              <div>
                ...
                <h3 className="text-xl font-bold mt-1">{userStats.activePlan}</h3>
              </div>
          ...
          <CardContent className="p-6">
            <div className="flex items-center justify-between">
              <div>
                ...
                <h3 className="text-xl font-bold mt-1">{userStats.nextPayment}</h3>
              </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        <Card className="lg:col-span-2">
          <CardHeader>
            ...
            <CardDescription>Tus reservaciones de vehículos actuales</CardDescription>
          </CardHeader>
          <CardContent>
                ...
                {activeReservations.map((reservation) => (
                  <div key={reservation.id} className="flex items-center gap-4 p-4 border rounded-lg">
                    ...
                    <div className="flex-grow">
                      <h4 className="font-semibold">{reservation.vehiculo}</h4>
